...
void DataBank::TextureRegister(std::string _id, std::string _path)
{
    for(std::list<Texture>::iterator it = textures.begin(); it != textures.end(); it++)
    {
        if(it->id == _id)
        {
            console("[MemBank]&e[Warning] Texture ID conflict. Recovery routine aborts registration");
            return;
        }
    }
...
void DataBank::TextureErase(std::string _id)
{
    ...
    console("[MemBank]&e[Warning] Tried erasing non-registered texture");
}
void DataBank::TextureLoad(std::string _id)
{
    ...
    console("[MemBank]&e[Warning] Tried loading non-registered texture");
}
void DataBank::TextureUnload(std::string _id)
{
    ...
    console("[MemBank]&e[Warning] Tried unloading non-registered texture");
}
sf::Texture* DataBank::TextureGet(std::string _id)
{
    ...
    console("[MemBank]&c[Error] Trying to load non-registered texture. In this case no recovery routine is available and the game might crash right after this message");
}
...
void DataBank::FontRegister(std::string _id, std::string _path)
{
    for(std::list<Font>::iterator it = fonts.begin(); it != fonts.end(); it++)
    {
        if(it->id == _id)
        {
            console("[MemBank]&e[Warning] Font ID conflict. Recovery routine aborts registration");
            return;
        }
    }
...
void DataBank::FontErase(std::string _id)
{
    ...
    console("[MemBank]&e[Warning] Tried erasing non-registered font");
}
void DataBank::FontLoad(std::string _id)
{
    ...
    console("[MemBank]&e[Warning] Tried loading non-registered font");
}
void DataBank::FontUnload(std::string _id)
{
    ...
    console("[MemBank]&e[Warning] Tried unloading non-registered font");
}
sf::Font* DataBank::FontGet(std::string _id)
{
    ...
    console("[MemBank]&c[Error] Trying to load non-registered font. In this case no recovery routine is available and the game might crash right after this message");
}
...
void DataBank::SoundRegister(std::string _id, std::string _path)
{
    for(std::list<Sound>::iterator it = sounds.begin(); it != sounds.end(); it++)
    {
        if(it->id == _id)
        {
            console("[MemBank]&e[Warning] Sound ID conflict. Recovery routine aborts registration");
            return;
        }
    }
...
void DataBank::SoundErase(std::string _id)
{
    ...
    console("[MemBank]&e[Warning] Tried erasing non-registered sound");
}
void DataBank::SoundLoad(std::string _id)
{
    ...
    console("[MemBank]&e[Warning] Tried loading non-registered sound");
}
void DataBank::SoundUnload(std::string _id)
{
    ...
    console("[MemBank]&e[Warning] Tried unloading non-registered sound");
}
sf::SoundBuffer* DataBank::SoundGet(std::string _id)
{
    ...
    console("[MemBank]&c[Error] Trying to load non-registered sound. In this case no recovery routine is available and the game might crash right after this message");
}
...
void DataBank::TrackRegister(std::string _id, std::string _path)
{
    for(std::list<Track>::iterator it = tracks.begin(); it != tracks.end(); it++)
    {
        if(it->id == _id)
        {
            console("[MemBank]&e[Warning] Track ID conflict. Recovery routine aborts registration");
            return;
        }
...
void DataBank::TrackErase(std::string _id)
{
    ...
    console("[MemBank]&e[Warning] Tried erasing non-registered track");
}
void DataBank::TrackLoad(std::string _id)
{
    ...
    console("[MemBank]&e[Warning] Tried loading non-registered track");
}
void DataBank::TrackUnload(std::string _id)
{
    ...
    console("[MemBank]&e[Warning] Tried unloading non-registered track");
}
sf::SoundBuffer* DataBank::TrackGet(std::string _id)
{
    ...
    console("[MemBank]&c[Error] Trying to load non-registered track. In this case no recovery routine is available and the game might crash right after this message");
}
