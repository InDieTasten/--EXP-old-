function onLoad() -- called right after the plugin has been loaded
	...
	pushTask("gui","menu", "access", "can", "element", "access", "canvas", "action", "draw", "line", "0","0","180","180")
	pushTask("gui","menu", "access", "can", "element", "access", "canvas", "action", "draw", "line", "0","180","180","0")
